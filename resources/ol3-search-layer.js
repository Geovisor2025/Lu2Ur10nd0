    ...
    horsey(input, {
      ...
      getValue: 'value',
       predictNextSearch: function(info) {
          console.log('search selection:', info.selection.value);
          ...
          // Fit or center zoom
         options.map.getView().fit(extent, {
    size: options.map.getSize(),
    duration: 100,
    maxZoom: 16, // Establece el nivel máximo de zoom deseado
    constrainResolution: false // Permite zooms intermedios
  });
